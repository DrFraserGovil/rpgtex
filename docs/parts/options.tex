...
\begin{ExampleBlock}{Section Names}
   We are in Chapter `\RpgChapterName{}', section `\RpgSectionName{}'.

   \subsubsection{An example subsubsection}

   Now I am in `\RpgSubsubsectionName{}'

   \chaptermark{Spoofed Chapter}
   
   I believe I am in a \RpgChapterName{}, though no chapter was actually called. 
