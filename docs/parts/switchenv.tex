\chapter{Feature Forge}\label{S:Forge}\label{S:SwitchEnv}
    ...
    \RpgMacro{RpgMakeFeature}{\param{m \paramO{} m m}}{
        ...
        \subsection{Quick Overview}
            ...
            \begin{description}
                ...
                \titem{\cmd{[EnvName]ShowCard}} A function which toggles the environment between \texttt{card-mode} (using \envref{RpgCard}) and \texttt{mode} (the default).
                \titem{\cmd[EnvName]CardFormat} Used to configure the appearance of the environment whilst in card-mode
                \titem{\cmd[EnvName]TextFormat} Used to configure the appearance of the environment while in text-mode
        ...
        \subsection{Creating New Features}
            ...
            \begin{enumerate}
                ...
                \begin{Code}
                    \cmd{RpgFooAddProperty}\param{description}\param{\cmd{}descriptString}\param{foo-bar}
                \end{Code}
...
% \newpage
    ...
    \featuresection{Text Mode Environment}
        Defines the text-mode environment and hooks
            ...
            \begin{enumerate}
                ...
                \RpgMacro{[EnvName]TextFormat}{\param{+m}}{Defines the body of the \texttt{EnvName} environment when in text-mode.}
                {
    ...
    \featuresection{Card Mode Environment}
            ...
            \begin{enumerate}
                ...
                \RpgMacro{[EnvName]CardFormat}{\param{+m}}{Defines the body of the \texttt{EnvName} environment when in text-mode.}
                {
    ...
    \featuresection{Create Text/Card Switch \& Wrapper Function}
        ...
        \RpgMacro{[EnvName]ShowCard}{\param{m}}{Sets the switch associated with the card equal to the value provided.}{
    ...
    \featuresection{Create Parameter Registry}\label{S:ParameterRegistry}
        \begin{enumerate}
            ...
            \RpgMacro{[EnvName]AddProperty}{\param{m m +m}}{
                Adds the specified key in to the key-list. When the key is passed to \texttt{EnvName}, it is saved as a \forcelink{https://texdoc.org/serve/interface3/0\#page=122}{token list}
            }
            {
