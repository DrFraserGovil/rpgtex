...
\section{RpgStat: D\&D Monsters}
    ...
    \subsection{Abilities, Attacks \& Spellcasting}
        ...
        \subsubsection{Ability Interface}
            ...
            \RpgMacro[RpgStat!Section]{RpgStatSection}{\statalias{section},\param{m}}{Creates a section header}{}
            {
...
\testBlock{}
            ...
            \RpgMacro[RpgStat!Action]{RpgStatAction}{\statalias{action},\statalias{trait},\param{\paramO{} m}}{Creates an action `paragraph'}{}
            {
                This is how all actions and traits are declared, providing a `name' in a format similar to the \cmd{paragraph} command.

                The optional argument is used to insert ``[X] actions'' into the action name. This is useful for Legendary Actions which might have a variable cost.
            }
...
\end{ExampleBlock}
            ...
            \RpgMacro[RpgStat!Reaction]{RpgStatReaction}{\statalias{reaction},\param{m m}}{Creates an action `paragraph' with an additional `trigger', indicating when the reaction may be used.}{}
            {}
\begin{ExampleBlock}{RpgStatReaction}
