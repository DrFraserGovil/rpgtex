...
\chapter{\texttt{dnd} Theme}\label{Theme:dnd}
    ...
    \section{Appearance}
        ...
        \subsection{RpgDice}\index{RpgDice}
            ...
            Following the syntax found in D\&D monster statblocks, RpgDice shows the average of the roll, and automatically converts 'dx' into '1dx':
            \RpgGetExample{dnd-dice}
    ...
    \RpgGetExample{dnd-item-example}
...
\section{RpgSpell}
    ...
    }
    {
        ...
        This function can only be called within an \texttt{RpgSpell} environemnt, as it relies on the local value of \cmd{l\_\_rpg\_dnd\_spell\_level\_tl}.
    }
    \ExplSyntaxOn
    \tl_set:Nn\l__rpg_dnd_spell_level_tl{3}
    \ExplSyntaxOff
    
    \RpgGetExample{dnd-spell-helper}

    \RpgGetExample{dnd-spell-full}
\clearpage
