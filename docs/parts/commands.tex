		...
		% In addition to the fundamental typeface alterations \rpgtex{} includes a number of commands to turn text into decorative elements.
			...
			\RpgMacro{RpgDropCap}{\param{\paramO{}, m m}}
				...
				}
				{
					...
					This command uses \forcelink{https://texdoc.org/serve/lettrine/0}{the lettrine package} and the \forcelink{https://ctan.org/pkg/magaz?lang=en}{magaz} package to create an easy-to-use environment in which the first letter is enlarged (and stylised in the \texttt{RpgFontDropCap}\index{Font!DropCap} font). The second argument formats \textit{up to the first line} of text in the \texttt{RpgFontDropCapInternal}\index{Font!DropCapInternal} font (usually a simple \texttt{scshape} command).
