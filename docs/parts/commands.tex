...
\chapter{Main Engine}
		...
		\subsection{User-Facing Commands}
			\begin{macrolist}
				...
				\RpgMacro{\subtitle,{{m}},\@subtitle}
					{
						\cmdidx{subtitle,{"@}subtitle}\label{Macro:subtitle}
	...
	\section{Part Pages}
		\begin{macrolist}
			...
			\RpgMacro{\RpgDrawPartPage,{{m}}}
				{\label{Macro:DrawPartPage}\cmdidx{RpgDrawPartPage}
	...
	\section{Dice Commands}
		...
		\begin{macrolist}
			\RpgMacro{\RpgDice,{{m}}}
				{\label{Macro:Dice}\cmdidx{RpgDice}
			...
			\RpgMacro{\RpgDiceFormat,{{m m m}}}
				{\label{Macro:DiceFormat}\cmdidx{RpgDiceFormat} Prints the values computed by \verb|RpgDice|
				}
				{
	...
	\section{Theme Commands}
		...
		\begin{macrolist}
			...
			\RpgMacro{\RpgSetThemeColor,{{m}}}
				{\label{Macro:SetThemeColor}\cmdidx{RpgSetThemeColor}
