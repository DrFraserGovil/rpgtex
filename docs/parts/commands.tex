...
\section{Utility Commands}
 	 \RpgMacro{RpgDice}{\param{{m}}}
        ...
        }
        {
            ...
            \cmd{RpgDice} is neat, but not necessarily impressive by itself. The true power of the expression is that it calls the control sequence set by \cmdref{RpgSetDiceFormat} to perform the output formatting (after performing the regular expression parsing), allowing designers to customise their dice formatting.
        }
