...
\labelsection{RpgCard}
    ...
    \subsection{The Environment}
        \RpgMacro*{RpgCard}{\param{\paramO}}{Splits the contents across a number of playing-card sized units}{
				...
				\begin{RpgTable}{llX}
					...
					\kve{text-width}{dimexpr}{The width of the text block}
				\end{RpgTable}
    ...
    \subsection{Helper Commands}
		...
		{
			The \texttt{<opts>} can contain any of the valid inputs to the \texttt{RpgCard} environment: this acts to set them as global default values. 
		}
