\chapter{Environments}
	...
	\labelsection{Rpg Boxes}
		...
		\begin{macrolist}
			\RpgMacro*{RpgNarration,{{o}}}{A \tcref{} wrapper designed for text that is read aloud to players}{
			...
			\RpgMacro*{RpgSidebar,{{o m}}}{A decorated \tcref{} wrapper designed for information which is set outside the main text.}{
			...
			\RpgMacro*{RpgTip,{{o m}}}{A simple \tcref{} wrapper designed for information which is set outside the main text.}{
