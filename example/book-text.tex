...
\end{RpgSidebar}
		...
		\begin{RpgMap}[depth=1,title={A test map},prefix=Room~,blank-prefix=Cell~,ref-prefix=forest:]
			
			\mapitem[A place]{}
			\begin{RpgMap}
				\mapitem[Another place] 
				\mapitem[test]
				\begin{RpgMap}
					\mapitem[Another place] 
					\begin{RpgMap}
					\mapitem[Another place 2]\label{example}
				...
				\end{RpgMap}
				\mapitem[tesdt]
				\RpgArea[garp]{Hello} I am trying this one now
			\end{RpgMap}
			\mapitem[here]
		\end{RpgMap}
		...
		Let's test: \RpgMapRef{forest:A place}

		And \RpgMapRef*{forest:A place}

		And then \RpgMapRefPage{forest:A place}
		
		
		And aoiwhd \RpgMapRefPage*{garp}
