...
\title{D\&D Book Test}
\subtitle{A Typesetting module for the world's greatest roleplaying game!}
...
\begin{document}
   ...
   \part[fantasy_title]{The D\&D Book Class}
    ...
    \begin{RpgMonsterSpells}[modifier=CHA,bonus=-9]
...
\end{RpgMonster*}
	...
	\Blindtext
	\Blindtext
	\part*[engine_part]{Basic Commands2}
	\part[engine_part]{Basic Commands3}
\end{document}
